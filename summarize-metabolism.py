...
parser.add_argument('--output', metavar='OUTFILE', default="metabolic-summary-results.txt", help="Output file name of summary results")
...
df_final.to_csv(os.path.join("results/", OUTFILE))
