...
optional.add_argument('--summary', metavar='OUTFILE', default="metabolic-summary-results.txt", help="Summary file of metabolic marker statistics in CSV format")
...
df_final.to_csv(os.path.join(OUTPUT,"/results/", OUTFILE))
